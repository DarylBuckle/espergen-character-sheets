...
interface IEsperGenCharacterProfileSheetProps {
...
interface IEsperGenCharacterProfileSheetState {
  character: EsperGenCharacter
}

const initialState: IEsperGenCharacterProfileSheetState = {
  character: {}
}

class EsperGenCharacterProfileSheet extends React.Component<
  IEsperGenCharacterProfileSheetProps,
  IEsperGenCharacterProfileSheetState
> {
  constructor(props: IEsperGenCharacterProfileSheetProps) {
    super(props)
        ...
        <div>
          <div className='row mb-4'>
            <div className='col-md-3 pr-2 pl-2'>
              <div className='espergen-page-title'>D&D</div>
              <div className='espergen-attribute-collection char-name pr-3 pl-3'>
                <input
                  type='text'
            ...
            <div className='col-md-9 pr-2 pl-2'>
              <div className='espergen-attribute-collection pr-3 pl-3'>
          ...
          <div className='row'>
            <div className='col-md-4'>
              <div className='espergen-box square'>
                <Image 
                  name='appearance'
                ...
                />
                <label className='espergen-title' style={{ marginTop: '10px' }}>
            ...
            <div className='col-md-8'>
              <div className='espergen-box'>
                <div className='row'>
                  <div className='col-md-6 border-right'>
                    <div className='espergen-gray-text' style={{ paddingBottom: '1px' }}>
                  ...
                  <div className='col-md-6'>
                    <div className='espergen-box gray noborder' style={{marginBottom: '13px'}}>
                      <div className='espergen-faction-input'>
                        <label>Faction</label>
                        <input
                          type='text'
              ...
              <div className='espergen-box mt-3'>
                ...
                <label className='espergen-title' style={{ marginTop: '4px' }}>
                  Treasure
                </label>
              </div>
            </div>
...
export default EsperGenCharacterProfileSheet
