...
interface IEsperGenCharacterSpellsSheetProps {
...
interface IEsperGenCharacterSpellsSheetState {
  character: EsperGenCharacter
}

const initialState: IEsperGenCharacterSpellsSheetState = {
  character: {}
}

class EsperGenCharacterSpellsSheet extends React.Component<
  IEsperGenCharacterSpellsSheetProps,
  IEsperGenCharacterSpellsSheetState
> {
  constructor(props: IEsperGenCharacterSpellsSheetProps) {
    super(props)
        ...
        <div>
          <div className='row mb-4'>
            ...
            <div className='col-md-9 pr-2 pl-2' style={{ marginTop: '18px' }}>
              <div className='espergen-attribute-collection gray pr-3 pl-3'>
...
export default EsperGenCharacterSpellsSheet
